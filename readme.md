...
# Solution Strategy
    ...
    - Automate the creation of test data
                                              ...
                                              - [INTRODUCTION AND GOALS](readme.md#introduction-and-goals)
                                                                - [BACKGROUND AND BUSINESS PROBLEM](readme.md#background-and-business-problem)
                                    - [SOLUTION STRATEGY](readme.md#solution-strategy)
                        - [ENVIRONMENT](readme.md#environment)
                              - [PRE-REQUISITES](readme.md#prerequisites)
                                                                - [LOGIN INTO YOUR AWS EKS CLUSTER](readme.md#login-into-your-aws-eks-cluster)
                  - [OVERVIEW](readme.md#overview)
            - [TOOLS](readme.md#tools)
                                - [GET THE AWS CLI](readme.md#get-the-aws-cli)
                        - [GET KUBECTL](readme.md#get-kubectl)
                                      - [GET THE ARGOCD CLI](readme.md#get-the-argocd-cli)
              - [ARGOCD](readme.md#argocd)
                                                                  - [CREATE A HOSTED ZONE IN ROUTE 53](readme.md#create-a-hosted-zone-in-route-53)
                                                                                    - [REQUEST A CERTIFICATE FOR THE HOSTED ZONE](readme.md#request-a-certificate-for-the-hosted-zone)
                                                                  - [INSTALL ARGOCD INTO YOUR CLUSTER](readme.md#install-argocd-into-your-cluster)
                                                                                  - [CREATE THE ARGOCY SERVICE PATCH TEMPLATE](readme.md#create-the-argocy-service-patch-template)
                                                                                                                    - [NOTE THE ARN IS COPIED FROM THE CREATE CERTIFICATE OUTPUT](readme.md#note-the-arn-is-copied-from-the-create-certificate-output)
                                                                                                - [UPDATE THE TEMPLATE WITH THE CORRECT ARN AND IP](readme.md#update-the-template-with-the-correct-arn-and-ip)
                                                                                          - [APPLY THE PATCH TO THE ARGOCD-SERVER SERVICE](readme.md#apply-the-patch-to-the-argocdserver-service)
                                                                                      - [CREATE AN ARGOCD RECORDSET IN THE NEW ZONE](readme.md#create-an-argocd-recordset-in-the-new-zone)
                                                            - [CREATE THE ARGOCD LOADBALNCER](readme.md#create-the-argocd-loadbalncer)
                                                                    - [UPDATE THE ARGOCD WEB UI PASSWORD](readme.md#update-the-argocd-web-ui-password)
                                                                              - [LOGIN TO ARGO CD FROM THE COMMAND LINE](readme.md#login-to-argo-cd-from-the-command-line)
                                                                  - [LOGIN TO ARGO CD FROM THE WEB UI](readme.md#login-to-argo-cd-from-the-web-ui)
                                        - [ADD USERS TO ARGOCD](readme.md#add-users-to-argocd)
                                                                                                    - [GENERATE A NEW PERSONAL ACCESS TOKEN FOR THE USER](readme.md#generate-a-new-personal-access-token-for-the-user)
                                                                          - [ADD YOUR GIT ACCESS TOKEN TO ARGO CD](readme.md#add-your-git-access-token-to-argo-cd)
                                        - [BUILDING BLOCK VIEW](readme.md#building-block-view)
                      - [DEPLOYMENT](readme.md#deployment)
                  - [SECURITY](readme.md#security)
          - [COST](readme.md#cost)
                                                    - [RISKS AND TECHNICAL DEBTS](readme.md#risks-and-technical-debts)
